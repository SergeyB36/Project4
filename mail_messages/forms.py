    ...
    def __init__(self, *args, **kwargs):
        ...
        if self.user and self.user.is_authenticated:
            ...
            if is_moderator:
                ...
                self.fields["recipients"].queryset = CustomMailRecipient.objects.filter(owner=self.user)
                self.fields["message"].queryset = CustomMessage.objects.filter(owner=self.user)
        else:
